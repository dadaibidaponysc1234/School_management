"""
Django settings for school_managementApp project.
...
SECRET_KEY = 'django-insecure-qp^gmm0*_(!x0cm3h+*n!4t)gv#pt3zcy1p2fr@kaz4um=p7fz'
...
CORS_ALLOW_ALL_ORIGINS = True  # Allow all (for testing only, restrict later)
...
WSGI_APPLICATION = 'school_managementApp.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3', # 'testdb.sqlite3',
    }
}
...
EMAIL_HOST = 'smtp.your_email_provider.com'  # Example: 'smtp.gmail.com'
